...
export default function Summaries() {
  ...
  // Animation state for summary box
  ...
  const generateSummary = async () => {
    ...
    try {
      ...
      setTimeout(() => setShowSummaryAnim(true), 100); // Animate summary in
    } catch (error: any) {
    ...
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className="container mx-auto px-4 py-8 pb-24">
        <div className="max-w-4xl mx-auto">
          ...
          {summary && (
            <div
              className={`rounded-3xl shadow-2xl border-2 border-blue-400/60 p-10 mb-10 mx-auto transition-all duration-500 bg-gradient-to-br ${
                darkMode
                  ? "from-gray-900 via-gray-800 to-gray-900 border-blue-900/40"
                  : "from-white via-blue-50 to-purple-100 border-blue-400/60"
              } min-h-[450px] max-h-[650px] flex flex-col justify-between animate-fade-in-up`}
              style={{
            ...
            >
              ...
              <div className={`p-6 rounded-lg border-l-4 overflow-y-auto min-h-[320px] max-h-[380px] mt-3 mb-2 ${
                darkMode
              ...
              <div className={`mt-5 text-sm text-right italic ${
                darkMode ? "text-gray-400" : "text-gray-600"
              }`}>
