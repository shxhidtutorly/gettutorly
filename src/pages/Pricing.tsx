          ...
          {plans.map((plan, index) => (
            <Card
              ...
              className={`relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl ${
                plan.popular 
                  ? 'ring-2 ring-spark-primary shadow-xl scale-105' 
                  : 'hover:shadow-lg'
              } animate-fade-in-up`}
            ...
            >
              ...
              <div className="absolute top-4 left-4 right-4">
                <div className={`${plan.badgeColor} px-3 py-1 rounded-full text-xs font-medium text-center`}>
                  {plan.badge}
                </div>
              </div>
        ...
        <div className="text-center space-y-8 animate-fade-in-up">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Join thousands of students who are already supercharging their learning with Tutorly's AI-powered tools.
            </p>
