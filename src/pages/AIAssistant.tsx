...
const AIChat = () => {
  ...
  return (
    <div className="flex flex-col bg-black rounded-lg shadow-2xl border border-gray-800 h-[700px] overflow-hidden transition-all duration-300">
      {/* Chat header */}
      <div className="flex items-center justify-between p-4 border-b border-gray-800 bg-black">
        <div className="flex items-center flex-1">
          ...
          <div>
            <span className="font-semibold text-white">AI Study Tutor</span>
        ...
        {messages.length > 1 && (
          <button
            onClick={clearChat}
            disabled={isLoading}
            className="flex items-center gap-2 px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-900 rounded-lg transition transform hover:scale-105"
            title="Clear chat"
          >
      ...
      <div className="flex-grow overflow-y-auto p-4 space-y-4 bg-black">
        {messages.map((message, index) => (
          ...
          >
            ...
            <div
              className={`max-w-[80%] p-4 shadow-md transition-all duration-300
                ${message.role === 'user'
                  ? 'bg-blue-600 text-white rounded-2xl rounded-br-md'
                  : 'bg-gray-900 text-white rounded-2xl rounded-bl-md border border-gray-800'
                }`
              }
            >
            ...
            {message.role === 'user' && (
              <div className="h-8 w-8 rounded-full bg-gray-700 flex items-center justify-center text-white ml-3 flex-shrink-0 mt-0.5">
        ...
        {isLoading && (
          <div className="flex justify-start animate-slideUpFadeIn">
            ...
            <div className="max-w-[80%] p-4 rounded-2xl rounded-bl-md bg-gray-900 border border-gray-800 shadow-md">
        ...
        <div className="flex items-end space-x-3">
          <div className="flex-grow">
            <textarea
              ...
              disabled={isLoading}
              rows={1}
              className="w-full py-3 px-4 bg-gray-900 border border-gray-800 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-all"
              style={{
                minHeight: '48px',
                maxHeight: '120px',
          ...
          <button
            ...
            className="flex items-center justify-center bg-blue-600 hover:bg-blue-700 disabled:bg-gray-800 text-white p-3 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-110"
          >
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                disabled={isLoading}
                className="px-4 py-2 text-sm bg-gray-800 rounded-full hover:bg-gray-700 text-gray-300 disabled:opacity-50 transition-colors border border-gray-800"
              >
      ...
      <main className="container py-8 text-white">
        ...
        <div className="mb-4">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm text-blue-400 hover:text-white bg-black border border-blue-700 rounded-lg shadow transition-all duration-200 hover:bg-blue-900 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-600 animate-fadeIn"
            style={{ fontWeight: 500 }}
          >
            <span style={{ fontSize: '1.2em' }}>←</span> Back to Dashboard
          </button>
        </div>
        <h1 className="text-3xl font-bold mb-6 text-center text-white animate-fadeIn">AI Learning Assistant</h1>
