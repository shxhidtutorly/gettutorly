...
// import { useSubscription } from "@/hooks/useSubscription"; // Temporarily commented out for testing

export default function SignupPage() {
  const navigate = useNavigate();
  const { signUp, signInWithGoogle } = useFirebaseAuth();
  const { user, isLoaded } = useUser();
  // const { hasActiveSubscription, loading: subLoading } = useSubscription(); // Temporarily commented out for testing
  ...
  // Temporarily redirects to the dashboard directly after signup, bypassing the subscription check.
  useEffect(() => {
    if (isLoaded && user) {
