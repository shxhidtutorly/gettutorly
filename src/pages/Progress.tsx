...
const ProgressPage = () => {
  ...
  const achievements = [
    { id: 1, title: "First Note Created", description: "Created your first AI note", icon: "📝", unlocked: true },
    { id: 2, title: "Quiz Master", description: "Completed 10 quizzes", icon: "🏆", unlocked: true },
    { id: 3, title: "Study Streak", description: "7 days in a row", icon: "🔥", unlocked: true },
    { id: 4, title: "Knowledge Seeker", description: "Asked 50 questions", icon: "🤔", unlocked: false },
    { id: 5, title: "Flashcard Pro", description: "Created 100 flashcards", icon: "⚡", unlocked: false },
    { id: 6, title: "Scholar", description: "1000 minutes studied", icon: "🎓", unlocked: false }
  ];
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#15192b] via-[#161c29] to-[#1b2236] text-white transition-colors">
      ...
      <main className="flex-1 py-4 md:py-8 px-4 pb-20 md:pb-8">
        <div className="container max-w-6xl mx-auto">
          ...
          >
            <Card className="bg-[#21253a] border-[#35357a] hover:border-purple-500/50 transition-all">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {studyGoals.map((goal, index) => (
                <Card key={index} className="bg-[#21253a] border-[#35357a]">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-2">
                ...
                <motion.div
                  ...
                  className={`p-4 rounded-lg border transition-all ${
                    achievement.unlocked
                      ? "bg-[#21253a] border-[#35357a] hover:border-purple-500/50"
                      : "bg-[#1a1a2e] border-[#2a2a3e] opacity-50"
                  }`}
                >
